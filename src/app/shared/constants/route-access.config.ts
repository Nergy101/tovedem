...
export const ROUTE_ACCESS_CONFIG: RouteAccessEntry[] = [
  ...
  { path: 'reservering-geslaagd', label: 'Reservering geslaagd', access: 'public' },
  ...
  { path: 'reservering-aanpassen/:id/:guid', label: 'Reservering aanpassen', access: 'logged-in' },
  { path: 'beheer-nieuwe-leden', label: 'Beheer nieuwe leden', access: ['admin', 'bestuur'] },
  { path: 'beheer-reserveringen', label: 'Beheer reserveringen', access: ['admin', 'bestuur', 'kassa'] },
  { path: 'kassa', label: 'Kassa', access: ['admin', 'bestuur', 'kassa'] },
  { path: 'printen', label: 'Printen', access: ['admin', 'bestuur', 'kassa', 'commissie'] },
  { path: 'beheer-voorstellingen', label: 'Beheer voorstellingen', access: ['admin', 'bestuur'] },
  { path: 'beheer-leden', label: 'Beheer leden', access: ['admin', 'bestuur'] },
  { path: 'beheer-spelers', label: 'Beheer spelers', access: ['admin', 'bestuur'] },
  { path: 'beheer-mails', label: 'Beheer mails', access: ['admin', 'bestuur'] },
  { path: 'beheer-sponsoren', label: 'Beheer sponsoren', access: ['admin', 'bestuur'] },
  { path: 'productie-info/Tovedem', label: 'Productie-info Tovedem', access: ['admin', 'bestuur', 'lid'] },
  { path: 'productie-info/Cloos', label: 'Productie-info Cloos', access: ['admin', 'bestuur', 'lid'] },
  { path: 'productie-info/Mejotos', label: 'Productie-info Mejotos', access: ['admin', 'bestuur', 'lid'] },
  { path: 'commissie-sinterklaas', label: 'Commissie Sinterklaas', access: ['admin', 'bestuur', 'commissie'] },
  { path: 'galerij', label: 'Galerij', access: ['admin', 'bestuur', 'commissie', 'lid'] },
  { path: 'galerij/:folderId', label: 'Galerij folder', access: ['admin', 'bestuur', 'commissie', 'lid'] },
